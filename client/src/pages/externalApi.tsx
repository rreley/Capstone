...
const ExternalApi = () => {
  ...
  const callSecureApi = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:5001/api/test/private`, {
        headers: {
  ...
  const callTestProspect = async () => {
    try {
      const response = await fetch(`http://localhost:5001/api/test/prospects`);
  ...
  const callProspect = async () => {
    try {
      const response = await fetch(`http://localhost:5001/api/prospects`);
      const responseData: API_Response = await response.json();
      console.log(responseData);
